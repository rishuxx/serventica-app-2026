...
const FALLBACK_BASICS: HomeBasicServiceItem[] = [
  ...
  { id: 's3', name: 'Electrician Quick Visit', slug: 'electrician-checkup', short_tagline: 'Within 20 mins', description: 'Switchboard repair, short circuits, socket burnt out, and power line troubleshooting', base_price: 149, image_url: 'basic_electric', rating: 4.86, category_id: 'c1000000-0000-0000-0000-000000000002', category_name: 'Electrical' },
  { id: 's4', name: 'Ceiling Fan Installation & Repair', slug: 'ceiling-fan-installation', short_tagline: 'Quick Service', description: 'Fast fan installation with balancing, capacitor replacement, and speed regulator tuning', base_price: 199, image_url: 'basic_fan_cooler', rating: 4.8, category_id: 'c1000000-0000-0000-0000-000000000002', category_name: 'Electrical' },
  { id: 's5', name: 'Tap & Water Leakage Repair', slug: 'tap-leakage-repair', short_tagline: 'Quick Plumber Arrival', description: 'Dripping taps, loose angle valves, waste pipe leak resolution, and washer replacements', base_price: 199, image_url: 'basic_plumbing', rating: 4.82, category_id: 'c1000000-0000-0000-0000-000000000003', category_name: 'Plumbing' },
  { id: 's6', name: 'Complete Home Deep Cleaning', slug: 'home-deep-cleaning', short_tagline: 'Top Rated Disinfection', description: 'Full house disinfection, kitchen grease removal, bathroom descaling, and floor scrubbing', base_price: 1499, image_url: 'basic_cleaning', rating: 4.92, category_id: 'c1000000-0000-0000-0000-000000000004', category_name: 'Cleaning' },
