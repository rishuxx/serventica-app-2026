...
VALUES
  ('s1000000-0000-0000-0001-000000000001', 'c1000000-0000-0000-0000-000000000001', 'ac-service-repair', 'AC Service & Repair', 'Split and window AC maintenance, repair, and gas refilling', 1, TRUE),
  ('s1000000-0000-0000-0001-000000000002', 'c1000000-0000-0000-0000-000000000001', 'refrigerator', 'Refrigerator', 'Single and double door fridge cooling and gas check', 2, TRUE),
  ('s1000000-0000-0000-0001-000000000003', 'c1000000-0000-0000-0000-000000000001', 'washing-machine', 'Washing Machine', 'Front load, top load, and semi-automatic drum repair', 3, TRUE),
  ('s1000000-0000-0000-0002-000000000001', 'c1000000-0000-0000-0000-000000000002', 'full-home-cleaning', 'Full Home Cleaning', 'Deep scrubbing and sanitization of whole houses', 1, TRUE),
  ('s1000000-0000-0000-0002-000000000002', 'c1000000-0000-0000-0000-000000000002', 'sofa-carpet', 'Sofa & Carpet', 'Injection-extraction fabric and leather shampooing', 2, TRUE),
  ('s1000000-0000-0000-0003-000000000001', 'c1000000-0000-0000-0000-000000000003', 'fans-lighting', 'Fans & Lighting', 'Ceiling fans, chandeliers, and decorative lights', 1, TRUE),
  ('s1000000-0000-0000-0003-000000000002', 'c1000000-0000-0000-0000-000000000003', 'wiring-mcb', 'Wiring & MCB', 'Short circuit tracing, main fuse box, and earthing', 2, TRUE),
  ('s1000000-0000-0000-0004-000000000001', 'c1000000-0000-0000-0000-000000000004', 'taps-mixers', 'Taps & Mixers', 'Dripping taps, shower mixers, and cartridge repair', 1, TRUE),
  ('s1000000-0000-0000-0004-000000000002', 'c1000000-0000-0000-0000-000000000004', 'drainage-blocks', 'Drainage & Blocks', 'Sink, bathroom drain, and pipeline unclogging', 2, TRUE)
ON CONFLICT (id) DO UPDATE SET
  slug = EXCLUDED.slug,
  name = EXCLUDED.name,
  description = EXCLUDED.description,
...
VALUES
  (
    ...
    's1000000-0000-0000-0001-000000000001',
    'ac-general-service',
    'AC General Service',
  ...
  (
    ...
    'c1000000-0000-0000-0000-000000000001',
    's1000000-0000-0000-0001-000000000002',
    'refrigerator-repair',
  ...
  (
    ...
    's1000000-0000-0000-0002-000000000001',
  ...
  (
    ...
    'c1000000-0000-0000-0000-000000000002',
    's1000000-0000-0000-0002-000000000002',
    'sofa-shampooing',
  ...
  (
    ...
    's1000000-0000-0000-0003-000000000001',
  ...
  (
    ...
    's1000000-0000-0000-0004-000000000001',
    'tap-leak-repair',
...
VALUES
  ...
  (
    'v1000000-0000-0000-0001-000000000001',
    'e1000000-0000-0000-0001-000000000001',
    'single-split-ac',
  ...
  (
    'v1000000-0000-0000-0001-000000000002',
    'e1000000-0000-0000-0001-000000000001',
    'twin-split-ac-pack',
  ...
  (
    'v1000000-0000-0000-0001-000000000003',
    'e1000000-0000-0000-0001-000000000001',
  ...
  (
    'v1000000-0000-0000-0001-000000000004',
    'e1000000-0000-0000-0001-000000000002',
    'standard-jet-clean',
  ...
  (
    'v1000000-0000-0000-0001-000000000005',
    'e1000000-0000-0000-0001-000000000002',
  ...
  (
    'v1000000-0000-0000-0002-000000000001',
    'e1000000-0000-0000-0002-000000000001',
    '1bhk-deep-cleaning',
    '1 BHK Apartment',
  ...
  (
    'v1000000-0000-0000-0002-000000000002',
    'e1000000-0000-0000-0002-000000000001',
    '2bhk-deep-cleaning',
    '2 BHK Apartment',
  ...
  (
    'v1000000-0000-0000-0002-000000000003',
    'e1000000-0000-0000-0002-000000000001',
    '3bhk-deep-cleaning',
  ...
  (
    'v1000000-0000-0000-0002-000000000004',
    'e1000000-0000-0000-0002-000000000002',
    '3-seater-sofa',
    '3-Seater Sofa',
  ...
  (
    'v1000000-0000-0000-0002-000000000005',
    'e1000000-0000-0000-0002-000000000002',
    '5-seater-sofa-set',
...
VALUES
  ('i1000000-0000-0000-0001-000000000001', 'e1000000-0000-0000-0001-000000000001', 'Indoor unit coil & filter wash', 'Deep wash of dust filters and internal coil fins', 1, TRUE),
  ('i1000000-0000-0000-0001-000000000002', 'e1000000-0000-0000-0001-000000000001', 'Drainage line flushing', 'Clear water blockage to prevent indoor water dripping', 2, TRUE),
  ('i1000000-0000-0000-0001-000000000003', 'e1000000-0000-0000-0001-000000000001', 'Refrigerant pressure & amp check', 'Precision digital gauge measurement for gas level', 3, TRUE),
  ('i1000000-0000-0000-0001-000000000004', 'e1000000-0000-0000-0001-000000000001', 'Post-service cooling verification', 'Thermostat airflow and delta-T verification report', 4, TRUE),

  ('i1000000-0000-0000-0001-000000000005', 'e1000000-0000-0000-0001-000000000002', 'High-pressure jet wash of indoor & outdoor coils', 'Blasts away deep grime without fin damage', 1, TRUE),
  ('i1000000-0000-0000-0001-000000000006', 'e1000000-0000-0000-0001-000000000002', 'Protective waterproof service jacket setup', 'Zero wall spillage with specialized catch bags', 2, TRUE),
  ('i1000000-0000-0000-0001-000000000007', 'e1000000-0000-0000-0001-000000000002', 'Outdoor unit condenser deep rinse', 'Removes caked dust for maximum heat dissipation', 3, TRUE),

  ('i1000000-0000-0000-0002-000000000001', 'e1000000-0000-0000-0002-000000000001', 'Kitchen degreasing & chimney exterior cleaning', 'Non-toxic degreasing on tiles, slabs and exhaust fans', 1, TRUE),
  ('i1000000-0000-0000-0002-000000000002', 'e1000000-0000-0000-0002-000000000001', 'Bathroom descaling & sanitization', 'Hard water stain removal from tiles, taps and commodes', 2, TRUE),
  ('i1000000-0000-0000-0002-000000000003', 'e1000000-0000-0000-0002-000000000001', 'Single-disc mechanized floor scrubbing', 'Restores natural shine across marble and vitrified tiles', 3, TRUE)
ON CONFLICT (id) DO UPDATE SET
  service_id = EXCLUDED.service_id,
...
VALUES
  ('x1000000-0000-0000-0001-000000000001', 'e1000000-0000-0000-0001-000000000001', 'Gas refill & spare parts', 'Available as standard add-on or quoted separately if required', 1, TRUE),
  ('x1000000-0000-0000-0001-000000000002', 'e1000000-0000-0000-0001-000000000001', 'Major copper pipe alterations or masonry drilling', 'Civil repairs not included', 2, TRUE),

  ('x1000000-0000-0000-0002-000000000001', 'e1000000-0000-0000-0002-000000000001', 'Inside locked wardrobes with personal belongings', 'Personal cabinets left untouched for privacy and security', 1, TRUE),
  ('x1000000-0000-0000-0002-000000000002', 'e1000000-0000-0000-0002-000000000001', 'Permanent paint stain removal or regrouting', 'Restoration services require separate carpentry/painting booking', 2, TRUE)
ON CONFLICT (id) DO UPDATE SET
  service_id = EXCLUDED.service_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
VALUES
  ...
  ('f1000000-0000-0000-0001-000000000001', 'e1000000-0000-0000-0001-000000000001', 'Will water spill onto my wall during servicing?', 'No. Our professionals use a dedicated waterproof catch jacket that directs all rinse water into an enclosed container, keeping walls and furniture dry.', 2, TRUE),
